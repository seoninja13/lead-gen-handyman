 ...
 * 
 * A reusable component for searching places using the Google Places API via MCP.
 * This component provides a search interface with autocomplete functionality.
 * It uses the MCP server for all API calls, providing better performance and security.
 */

import React, { useState, useEffect } from 'react';
import { PlaceData } from '../lib/google-places-client';
import { searchPlaces } from '../lib/google-places-mcp';
...
const PlacesSearchMcp: React.FC<PlacesSearchMcpProps> = ({
  onPlaceSelect,
  onPlacesFound,
  initialQuery = '',
