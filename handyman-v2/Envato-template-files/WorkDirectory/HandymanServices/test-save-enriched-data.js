...
const { saveEnrichedData } = require('./utils/saveEnrichedDataToTestDelete');
...
async function testSaveEnrichedData() {
  try {
    console.log('Testing saving enriched data...');
    
    const result = await saveEnrichedData(businessName, enrichedData);
    ...
    console.error('Error testing save enriched data:', error);
  }
}

// Run the function
testSaveEnrichedData();
